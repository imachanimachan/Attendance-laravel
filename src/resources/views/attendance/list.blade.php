...
<div class="attendance-list__header">
	<a href="{{ route('attendance.list', ['year' => $prevYear, 'month' => $prevMonth]) }}" class="attendance-list__month-button">← 前月</a>
    ...
    <a href="{{ route('attendance.list', ['year' => $nextYear, 'month' => $nextMonth]) }}" class="attendance-list__month-button">翌月 →</a>
</div>
			...
			<tbody class="attendance-list__tbody">
				@foreach ($attendances as $attendance)
                    ...
                    <td class="attendance-list__cell">
						...
						<td class="attendance-list__cell"><a href="{{ route( 'attendance.show' ,['id' => $attendance->id]) }}" class="attendance-list__detail-link">詳細</a></td>
					</tr>
				@endforeach
			</tbody>
		</table>
