...
@section('content')
	<div class="attendance-request__container">
		...
		<div class="attendance-request__tabs">
			<a href="/stamp_correction_request/list?tab=pending" class="attendance-request__tab-link {{ request('tab', 'pending') === 'pending' ? 'attendance-request__tab-link--active' : '' }}">承認待ち</a>
			<a href="/stamp_correction_request/list?tab=approved" class="attendance-request__tab-link {{ request('tab', 'approved') === 'approved' ? 'attendance-request__tab-link--active' : '' }}">承認済み</a>
		</div>
			...
			<tbody class="attendance-request__tbody">
				...
				<tr class="attendance-request__row">
					...
					<td class="attendance-request__cell">
						<a href="{{ route( 'attendance.show' ,['id' => $attendanceRevision->attendance->id]) }}" class="attendance-request__link">詳細</a>
					</td>
				</tr>
				@endforeach
			</tbody>
